...
static const char *FileLoadOperationClassPathName = "org/لایو گرام/tgnet/FileLoadOperation";
...
static const char *NativeByteBufferClassPathName = "org/لایو گرام/tgnet/NativeByteBuffer";
...
static const char *ConnectionsManagerClassPathName = "org/لایو گرام/tgnet/ConnectionsManager";
static JNINativeMethod ConnectionsManagerMethods[] = {
        ...
        {"native_sendRequest", "(ILorg/لایو گرام/tgnet/RequestDelegateInternal;Lorg/لایو گرام/tgnet/QuickAckDelegate;Lorg/لایو گرام/tgnet/WriteToSocketDelegate;IIIZI)V", (void *) sendRequest},
...
extern "C" int registerNativeTgNetFunctions(JavaVM *vm, JNIEnv *env) {
    ...
    jclass_RequestDelegateInternal = (jclass) env->NewGlobalRef(env->FindClass("org/لایو گرام/tgnet/RequestDelegateInternal"));
    ...
    jclass_QuickAckDelegate = (jclass) env->NewGlobalRef(env->FindClass("org/لایو گرام/tgnet/QuickAckDelegate"));
    if (jclass_RequestDelegateInternal == 0) {
        return JNI_FALSE;
    }
    ...
    jclass_WriteToSocketDelegate = (jclass) env->NewGlobalRef(env->FindClass("org/لایو گرام/tgnet/WriteToSocketDelegate"));
    ...
    jclass_FileLoadOperationDelegate = (jclass) env->NewGlobalRef(env->FindClass("org/لایو گرام/tgnet/FileLoadOperationDelegate"));
    ...
    jclass_ConnectionsManager = (jclass) env->NewGlobalRef(env->FindClass("org/لایو گرام/tgnet/ConnectionsManager"));
