/*
This file is part of لایو گرام Desktop,
the official desktop version of لایو گرام messaging app, see https://لایو گرام.org

لایو گرام Desktop is free software: you can redistribute it and/or modify
...
Full license: https://github.com/لایو گرامdesktop/tdesktop/blob/master/LICENSE
Copyright (c) 2014-2017 John Preston, https://desktop.لایو گرام.org
*/
...
jobjectArray
Java_org_لایو گرام_messenger_Emoji_getSuggestion(JNIEnv *env, jobject object, jstring query) {
    ...
    if (jclass_Suggestion == nullptr) {
        jclass_Suggestion = (jclass) env->NewGlobalRef(env->FindClass("org/لایو گرام/messenger/EmojiSuggestion"));
