...
import org.laivgram.ui.Components.RoundVideoPlayingDrawable;
import org.laivgram.ui.Components.SeekBar;
import org.laivgram.ui.Components.SeekBarWaveform;
import org.laivgram.ui.Components.StaticLayoutEx;
...
import org.laivgram.ui.PhotoViewer;
import org.laivgram.ui.SecretMediaViewer;
    ...
    public void setMessageObject(MessageObject messageObject, MessageObject.GroupedMessages groupedMessages, boolean bottomNear, boolean topNear) {
        ...
        if (messageChanged || dataChanged || groupChanged || isPhotoDataChanged(messageObject) || pinnedBottom != bottomNear || pinnedTop != topNear) {
            ...
            if (messageObject.type == 0) {
                ...
                if (!drawInstantView) {
                    if ("لایو گرام_channel".equals(webpageType)) {
                        drawInstantView = true;
                        drawInstantViewType = 1;
                    } else if ("لایو گرام_megagroup".equals(webpageType)) {
                        drawInstantView = true;
