...
import org.laivgram.ui.Cells.AboutLinkCell;
...
import org.laivgram.ui.Cells.TextCell;
import org.laivgram.ui.Cells.TextDetailCell;
import org.laivgram.ui.Cells.TextInfoPrivacyCell;
...
import org.laivgram.ui.Components.IdenticonDrawable;
    ...
    private boolean processOnClickOrPress(final int position) {
        if (position == usernameRow || position == channelNameRow) {
            ...
            if (userFull != null && userFull.phone_calls_available) {
                items.add(LocaleController.getString("CallViaلایو گرام", R.string.CallViaلایو گرام));
                actions.add(2);
            }
