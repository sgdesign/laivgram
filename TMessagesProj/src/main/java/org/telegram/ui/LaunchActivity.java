...
import org.laivgram.messenger.LocationController;
...
import org.laivgram.messenger.NativeCrashManager;
...
import org.laivgram.messenger.camera.CameraController;
        ...
        sideMenu.setOnItemClickListener(new RecyclerListView.OnItemClickListener() {
            ...
            public void onItemClick(final View view, int position) {
                ...
                if (position == 0) {
                    ...
                    Browser.openUrl(LaunchActivity.this, LocaleController.getString("لایو گرامFaqUrl", R.string.لایو گرامFaqUrl));
                    drawerLayoutContainer.closeDrawer(false);
                } else if (id == 10) {
        ...
        if (!fromPassword && (AndroidUtilities.needShowPasscode(true) || UserConfig.isWaitingForPasscodeEnter)) {
            ...
            if (UserConfig.isClientActivated() && (flags & Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY) == 0) {
                if (intent != null && intent.getAction() != null && !restore) {
                        ...
                        if (data != null) {
                            ...
                            if (scheme != null) {
                                if ((scheme.equals("http") || scheme.equals("https"))) {
                                    ...
                                    if (host.equals("لایو گرام.me") || host.equals("t.me") || host.equals("لایو گرام.dog") || host.equals("telesco.pe")) {
                                    ...
                                    if (url.startsWith("tg:resolve") || url.startsWith("tg://resolve")) {
                                        url = url.replace("tg:resolve", "tg://لایو گرام.org").replace("tg://resolve", "tg://لایو گرام.org");
                                        data = Uri.parse(url);
                                        ...
                                        url = url.replace("tg:join", "tg://لایو گرام.org").replace("tg://join", "tg://لایو گرام.org");
                                        data = Uri.parse(url);
                                        group = data.getQueryParameter("invite");
                                    } else if (url.startsWith("tg:addstickers") || url.startsWith("tg://addstickers")) {
                                        url = url.replace("tg:addstickers", "tg://لایو گرام.org").replace("tg://addstickers", "tg://لایو گرام.org");
                                        data = Uri.parse(url);
                                        ...
                                        url = url.replace("tg:msg", "tg://لایو گرام.org").replace("tg://msg", "tg://لایو گرام.org").replace("tg://share", "tg://لایو گرام.org").replace("tg:share", "tg://لایو گرام.org");
                                        data = Uri.parse(url);
                                        message = data.getQueryParameter("url");
                                        if (message == null) {
                                            message = "";
                    ...
                    } else if (intent.getAction().equals("org.laivgram.messenger.OPEN_ACCOUNT")) {
                        open_settings = 1;
