...
import org.laivgram.tgnet.SerializedData;
...
import org.laivgram.ui.Cells.TextInfoCell;
import org.laivgram.ui.Cells.EmptyCell;
import org.laivgram.ui.Cells.HeaderCell;
import org.laivgram.ui.Cells.ShadowSectionCell;
import org.laivgram.ui.Cells.TextCheckCell;
import org.laivgram.ui.Cells.TextDetailSettingsCell;
import org.laivgram.ui.Cells.TextSettingsCell;
...
import org.laivgram.ui.Components.AvatarDrawable;
import org.laivgram.ui.Components.AvatarUpdater;
...
import org.laivgram.ui.Components.NumberPicker;
        ...
        listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() {
            ...
            public void onItemClick(View view, final int position) {
                if (position == textSizeRow) {
                    ...
                    builder.setNegativeButton(LocaleController.getString("Cancel", R.string.Cancel), null);
                    showDialog(builder.create());
                } else if (position == لایو گرامFaqRow) {
                    Browser.openUrl(getParentActivity(), LocaleController.getString("لایو گرامFaqUrl", R.string.لایو گرامFaqUrl));
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
            ...
            switch (holder.getItemViewType()) {
                ...
                case 2: {
                    ...
                    if (position == textSizeRow) {
                        ...
                        textCell.setText(LocaleController.getString("لایو گرامFAQ", R.string.لایو گرامFAQ), true);
                    } else if (position == contactsReimportRow) {
        ...
        public boolean isEnabled(RecyclerView.ViewHolder holder) {
            ...
            return position == textSizeRow || position == enableAnimationsRow || position == notificationRow || position == backgroundRow || position == numberRow ||
                    ...
                    position == switchBackendButtonRow || position == لایو گرامFaqRow || position == contactsSortRow || position == contactsReimportRow || position == saveToGalleryRow ||
            ...
            switch (viewType) {
                ...
                case 5:
                    ...
                    try {
                        ...
                        ((TextInfoCell) view).setText(LocaleController.formatString("لایو گرامVersion", R.string.لایو گرامVersion, String.format(Locale.US, "v%s (%d) %s", pInfo.versionName, code, abi)));
                    } catch (Exception e) {
                        FileLog.e(e);
                    }
                    break;
